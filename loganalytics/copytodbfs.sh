...
sed -i "s/export LOG_ANALYTICS_WORKSPACE_ID=.*/LOG_ANALYTICS_WORKSPACE_ID=\"$LOG_ANALYTICS_WORKSPACE_ID\"/g" ./listeners.sh
sed -i "s/export LOG_ANALYTICS_WORKSPACE_KEY=.*/LOG_ANALYTICS_WORKSPACE_KEY=\"$LOG_ANALYTICS_WORKSPACE_KEY\"/g" ./listeners.sh
